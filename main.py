...
# Prints all of the information of the project then asks for conformation as to whether they want to use it
...
def main():
    while True:
        ...
        match input('1. What is a portfolio and how do I use this one? \n2. Projects \n3. Exit \nEnter the number of the option you select: '):
            ...
            case '1':
                ...
                print('To use this one, go to the projects section and select a project to look at the information. You can then run the project or you can leave and look at another project.')
            ...
            case '2':
                while True:
                    ...
                    # Selects the project that the user wants to use
